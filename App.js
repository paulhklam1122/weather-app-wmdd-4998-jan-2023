...
export default function App() {
  ...
  const fetchCityData = async city => {
    const url = `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=edccb98583bea4ee4057dd31360da500&units=metric`
  ...
  return (
    <View style={styles.container}>
      ...
      <Content city={city} temp={temp} weather={weather} />
